...
// https://raw.githubusercontent.com/dotnet/corert/master/src/System.Private.CoreLib/shared/System/TimeZoneInfo.AdjustmentRule.cs
namespace System
{
    ...
    public sealed partial class TimeZoneInfo
    {
        ...
        public sealed class AdjustmentRule 
            : IEquatable<AdjustmentRule>, ISerializable, IDeserializationCallback
        {
            ...
            private AdjustmentRule(SerializationInfo info, StreamingContext context)
            {
                ...
                try
                {
                    ...
                    o = info.GetValue("BaseUtcOffsetDelta", typeof(TimeSpan)); // Do not rename (binary serialization)
                ...
                try
                {
                    o = info.GetValue("NoDaylightTransitions", typeof(bool)); // Do not rename (binary serialization)
                    if (o != null)
                    {
