...
namespace System.Threading
{
    ...
    {
        public static void Dispose2(this EventWaitHandle handle)
        {
            //protected virtual void Dispose(bool explicitDisposing);
            System.Reflection.MethodInfo mi = typeof(EventWaitHandle).GetMethod("Dispose", Reflection.BindingFlags.Instance | Reflection.BindingFlags.NonPublic);
            mi.Invoke(handle, new object[] {  true });
        }
    }
    ...
    public class ReaderWriterLockSlim : IDisposable
    {
        ...
        private bool TryEnterReadLockCore(TimeoutTracker timeout)
        {
            ...
            int id = Environment2.CurrentManagedThreadId;
        ...
        public void ExitReadLock()
        {
            ...
            if (_fIsReentrant)
            {
                ...
                if (Environment2.CurrentManagedThreadId == _upgradeLockOwnerId)
                {
        ...
        public void ExitWriteLock()
        {
            ...
            if (!_fIsReentrant)
            {
                if (Environment2.CurrentManagedThreadId != _writeLockOwnerId)
                {
        ...
        private void Dispose(bool disposing)
        {
            if (disposing && !_fDisposed)
            {
                ...
                {
                    _upgradeEvent.Dispose2();
                    _upgradeEvent = null;
                }

                if (_waitUpgradeEvent != null)
                {
                    _waitUpgradeEvent.Dispose2();
